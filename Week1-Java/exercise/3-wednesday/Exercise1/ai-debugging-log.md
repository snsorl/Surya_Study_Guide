...
#  at com.revature.Wed.RosterApp.main(RosterApp.java:11)
#
...
# 
# This is the outputted error: Exception in thread "main" java.lang.ClassCastException: class com.revature.Wed.Airplane cannot be cast to class com.revature.Wed.Car (com.revature.Wed.Airplane and com.revature.Wed.Car are in unnamed module of loader 'app')
#	at com.revature.Wed.AirportApp.main(AirportApp.java:12)
#
# -------------------------------------------------------------------------------------
#
...
#   at com.revature.Wed.FinancialApp.computeScore(FinancialApp.java:5)
#   at com.revature.Wed.FinancialApp.main(FinancialApp.java:10)
#
# -------------------------------------------------------------------------------------
#
